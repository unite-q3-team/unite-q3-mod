...
// spawn items flags
#define ITEMMASK_HEALTH   1
#define ITEMMASK_ARMOR    2
#define ITEMMASK_WEAPONS  4
...
typedef struct {
	...
	qboolean	authed;            // persist auth across map changes/restarts
} clientSession_t;
...
struct gclient_s {
	...
	int			hookAttachTime;     // level.time when offhand hook attached
